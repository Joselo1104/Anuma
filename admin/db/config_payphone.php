...
// Obtener teléfono del usuario para pre-llenar
...
<body>
    ...
    <?php include "perfil.php"; // O tu menú ?>
    ...
    <div class="pay-box">
        ...
        <p class="info-text">
            <i class="fas fa-mobile-alt"></i> Al hacer clic, recibirás una notificación en tu App Payphone para aprobar el pago.
        </p>
    </div>
