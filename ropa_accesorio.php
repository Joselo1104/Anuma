...
$where = ["c.nombre = 'ROPA'", "p.disponible = 1"];
$params = [];
    ...
    <div class="layout">
        ...
        <section>
            ...
            <div class="subcategories-row">
                <a class="subcategory-pill <?php echo $subcat_filtro === '' ? 'active' : ''; ?>" href="ropa_accesorio.php">Todo</a>
                <a class="subcategory-pill <?php echo $subcat_filtro === 'vestimenta' ? 'active' : ''; ?>" href="ropa_accesorio.php?subcat=vestimenta">Vestimenta</a>
                <a class="subcategory-pill <?php echo $subcat_filtro === 'accesorios' ? 'active' : ''; ?>" href="ropa_accesorio.php?subcat=accesorios">Accesorios</a>
                <a class="subcategory-pill <?php echo $subcat_filtro === 'calzado' ? 'active' : ''; ?>" href="ropa_accesorio.php?subcat=calzado">Calzado</a>
                <a class="subcategory-pill <?php echo $subcat_filtro === 'pantalones' ? 'active' : ''; ?>" href="ropa_accesorio.php?subcat=pantalones">Pantalones</a>
                <a class="subcategory-pill <?php echo $subcat_filtro === 'interior' ? 'active' : ''; ?>" href="ropa_accesorio.php?subcat=interior">Interiores</a>
            </div>
            ...
            <?php if ($total_paginas > 1): ?>
                <div class="pagination">
                    <?php if ($pagina_actual > 1): ?>
                        <a href="ropa_accesorio.php?page=<?php echo max(1, $pagina_actual - 1); ?><?php echo $pag_query; ?>">«</a>
                    <?php endif; ?>
                    <?php
                        $pages = [];
                        if ($total_paginas <= 7) {
                        ...
                        foreach ($pages as $p):
                            ...
                            <?php else: ?>
                                <a href="ropa_accesorio.php?page=<?php echo $p; ?><?php echo $pag_query; ?>"><?php echo $p; ?></a>
                            <?php endif;
                        endforeach;
                    ?>
                    <?php if ($pagina_actual < $total_paginas): ?>
                        <a href="ropa_accesorio.php?page=<?php echo min($total_paginas, $pagina_actual + 1); ?><?php echo $pag_query; ?>">»</a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </section>
