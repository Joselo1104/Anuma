...
$where = ["c.nombre = 'PAPELERIA'", "p.disponible = 1"];
$params = [];
    ...
    <div class="layout">
        ...
        <section>
            ...
            <div class="section-title">
                <h3>Materiales de Oficina</h3>
            </div>
            <div class="subcategories-row">
                <a class="subcategory-pill <?php echo $subcat_filtro === '' ? 'active' : ''; ?>" href="papeleria.php">Todo</a>
                <a class="subcategory-pill <?php echo $subcat_filtro === 'escritura' ? 'active' : ''; ?>" href="papeleria.php?subcat=escritura">Escritura</a>
                <a class="subcategory-pill <?php echo $subcat_filtro === 'libretas' ? 'active' : ''; ?>" href="papeleria.php?subcat=libretas">Libretas</a>
                <a class="subcategory-pill <?php echo $subcat_filtro === 'organizador' ? 'active' : ''; ?>" href="papeleria.php?subcat=organizador">Organizador</a>
            </div>
            ...
            <?php if ($total_paginas > 1): ?>
                <div class="pagination">
                    <?php if ($pagina_actual > 1): ?>
                        <a href="papeleria.php?page=<?php echo max(1, $pagina_actual - 1); ?><?php echo $pag_query; ?>">«</a>
                    <?php endif; ?>
                    <?php
                        $pages = [];
                        if ($total_paginas <= 7) {
                        ...
                        foreach ($pages as $p):
                            ...
                            <?php else: ?>
                                <a href="papeleria.php?page=<?php echo $p; ?><?php echo $pag_query; ?>"><?php echo $p; ?></a>
                            <?php endif;
                        endforeach;
                    ?>
                    <?php if ($pagina_actual < $total_paginas): ?>
                        <a href="papeleria.php?page=<?php echo min($total_paginas, $pagina_actual + 1); ?><?php echo $pag_query; ?>">»</a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </section>
